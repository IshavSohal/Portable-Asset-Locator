...
function MainTemplate({
  ...
  return (
    <GcdsContainer size="full" centered>
      ...
      <GcdsContainer className="main-content" size="xl" centered padding="0" margin="0" style={{marginLeft: 10}}>
        <div> {children} </div>
      </GcdsContainer>

      <GcdsContainer className="footer-content" size="xl" centered style={{backgroundColor: '#33465C', paddingTop: 1, marginBottom: -15 }}>
