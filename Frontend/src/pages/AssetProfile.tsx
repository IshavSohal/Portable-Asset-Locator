        ...
        <MainTemplate currentPage="my-assets">
            ...
            >
                <GcdsContainer size="lg" border >
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', paddingLeft: 20}}>
                        <GcdsText style={{ paddingRight: 10, maxWidth: 180}}>
                            <div style={{fontWeight: 'bold'}}> Asset name: </div>
                            <div>{asset.name ?? 'N/A'}</div>
                            <div style={{fontWeight: 'bold', paddingTop: 20}}> Serial number: </div>
                ...
                <GcdsContainer size="xs" border>
                    ...
                    <GcdsText style={{ overflowWrap: 'break-word', padding: '0px 20px', paddingLeft: 20}}> 
                        {asset.comment ?? 'N/A'} 
                    </GcdsText>
                </GcdsContainer>
            </GcdsGrid>
                ...
                <GcdsContainer size="lg" style={{background: '#F1F2F3'}} >
                    ...
                    <div style={{display: 'flex', justifyContent: 'space-between', flexWrap: 'wrap', paddingLeft: 20}}>
                        ...
                        <GcdsText style={{ paddingRight: 10, maxWidth: 180}}>
                            ...
                            <div>{asset.cost && asset.cost !== 'N/A' ? '$' + asset.cost : 'N/A'}</div>
                        </GcdsText>
                        <GcdsText style={{ paddingRight: 10, maxWidth: 180}}>
                        ...
                        <GcdsText style={{ paddingRight: 20, maxWidth: 200}}>
                            ...
                            <div>
                                ...
                                ? dateFormatter(asset.warrantyStartDate, true) + ' to ' + dateFormatter(asset.warrantyEndDate, true) 
                                : 'N/A'}
                            </div>
                        </GcdsText>
                    </div>
